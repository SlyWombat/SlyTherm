// cam_probe_regs.h — OV02C10 register tables for the #150 camera probe.
// GENERATED from the Guition vendor SDK mirror (sukesh-ak/JC8012P4A1-...,
// esp_cam_sensor/sensors/ov02c10) — Espressif Apache-2.0 driver sources.
#pragma once
#include <stdint.h>

typedef struct { uint16_t reg; uint8_t val; } ov02c10_reginfo_t;
...
#define BIT(n) (1u << (n))
#endif
#define OV02C10_MIPI_CSI_LINE_RATE_1920x1080_30FPS (81666700ULL * 5)
